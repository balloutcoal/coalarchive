...
HD_PWD='C:/Users/coal/Documents/ECE2700/MUX/MUX.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sixteencsAdd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sixteencsAdd.tcl -notrace
