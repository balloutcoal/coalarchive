...
HD_PWD='C:/Users/coal/Documents/coalarchive/USU/FALL24/ece2700/DoubleSevenSegment/DoubleSevenSegment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DoubleSevenSegment.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DoubleSevenSegment.tcl -notrace
