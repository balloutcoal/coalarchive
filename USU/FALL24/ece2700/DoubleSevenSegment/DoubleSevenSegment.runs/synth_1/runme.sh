...
HD_PWD='C:/Users/coal/Documents/coalarchive/USU/FALL24/ece2700/DoubleSevenSegment/DoubleSevenSegment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DoubleSevenSegment.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DoubleSevenSegment.tcl
